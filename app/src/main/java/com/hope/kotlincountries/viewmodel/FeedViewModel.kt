...
import com.hope.kotlincountries.service.CountryAPIService
import com.hope.kotlincountries.service.CountryDatabase
import com.hope.kotlincountries.util.CustomSharedPreferences
...
class FeedViewModel(application: Application) : BaseViewModel(application) {
    ...
    private fun getDataFromSQLite(){
        launch {
            ...
            Toast.makeText(getApplication(),"Countries from SQLlite",Toast.LENGTH_LONG).show()
        }
    }
